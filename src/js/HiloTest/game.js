define('HiloTest/game', ['hilo/view/Stage', 'hilo/util/Ticker', 'hilo/view/Bitmap', 'HiloTest/mediator', 'HiloTest/resource', 'HiloTest/loading'], function(Stage, Ticker, Bitmap, mediator, resource, loading){

/**
 * @module HiloTest/game
 * @requires hilo/view/Stage
 * @requires hilo/util/Ticker
 * @requires hilo/view/Bitmap
 * @requires HiloTest/mediator
 * @requires HiloTest/resource
 * @requires HiloTest/loading
 */
var game = {
